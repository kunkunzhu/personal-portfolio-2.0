            ...
            <Section>
                ...
                <Paragraph>
                    ...
                    <div className="paragraph">
                        ...
                        As for typography, &thinsp;<a href="https://www.lexend.com/"  target="_blank">Lexend</a>, 
                    ...
                    <div className="paragraph">
                        Check out our <a href="https://www.figma.com/file/nmoby3dv4F4I0qDoQEq30L/Hi-Fidelity-Website?node-id=1%3A6" target="_blank">Figma files
                        </a> and the <a href="https://www.2021.itstechnova.org/" target="_blank">final website</a>!
                    </div>
                    <hr className="subdivider"/>
                    
                    <div className="paragraph"><h5 className="subheading">3. Social Media Graphics</h5> 
